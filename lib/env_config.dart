...
class EnvConfig {
  ...
  static String get behaviourRemoveOwnedObjectsUrl => dotenv.env['BEHAVIOUR_REMOVE_OWNED_OBJECTS_URL'] ?? '';
  ...
  static String get ecomHubRecommendationsUrl => dotenv.env['ECOM_HUB_RECOMMENDATIONS_URL'] ?? '';
